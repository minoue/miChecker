...
class ModelChecker(QtWidgets.QDialog):
    """ Main UI class """
    ...
    def createUI(self):
        ...
        # Top Area Widgets
        self.selectedLE = QtWidgets.QLineEdit()
        ...
        for i in self.checkList:
            # Create checkbox
            exec("self.%sCheckBox = QtWidgets.QCheckBox('%s')" % (i, i))
            ...
            exec("self.%sListWidget = QtWidgets.QListWidget()" % i)
            exec(
            ...
            exec(
                ...
                "(QtWidgets.QAbstractItemView.ExtendedSelection)" % i)

            exec("self.%sResultLabel = widget.CustomLabel('%s')" % (i, i))

        self.presetCB = QtWidgets.QComboBox()
        ...
        self.geoSuffixLineEdit01 = QtWidgets.QLineEdit("_GEP")
        self.geoSuffixLineEdit02 = QtWidgets.QLineEdit("_GES")
        self.geoSuffixLineEdit03 = QtWidgets.QLineEdit("_NRB")
        self.geoSuffixLineEdit04 = QtWidgets.QLineEdit("_GRP")
        self.geoSuffixLineEdit05 = QtWidgets.QLineEdit("_LOC")
        self.geoSuffixLineEdit06 = QtWidgets.QLineEdit("_PLY")
        self.resetButton = QtWidgets.QPushButton("Reset")
        self.resetButton.setFixedHeight(40)
        self.resetButton.clicked.connect(self.resetSetting)

        # Bad nodes list widget
        self.badNodeListWidget = QtWidgets.QListWidget()
    ...
    def layoutUI(self):
        ...
        topLayout = widget.CustomBoxLayout(QtWidgets.QBoxLayout.LeftToRight)
        ...
        errorListLayout = QtWidgets.QVBoxLayout(scrollAreaWidgetContents)
        for i in self.checkList:
            errorListLayout.addWidget(QtWidgets.QLabel(i))
        ...
        # Set splitter
        midSplitter = QtWidgets.QSplitter()
        midWidgetA = QtWidgets.QWidget()
        midWidgetB = QtWidgets.QWidget()
        ...
        mainLayout = widget.CustomBoxLayout(QtWidgets.QBoxLayout.TopToBottom)
    ...
    def search(self):
        ...
        for item in self.badNodeList:
            ...
            widgetItem = QtWidgets.QListWidgetItem(item)
